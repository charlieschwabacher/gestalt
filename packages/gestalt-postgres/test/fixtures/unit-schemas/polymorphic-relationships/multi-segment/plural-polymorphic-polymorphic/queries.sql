SELECT blogs.*, tweets.* FROM agent_authored_pieces
  LEFT JOIN blogs ON
    agent_authored_pieces.authored_piece_type = 'Blog' AND
    blogs.id = agent_authored_pieces.authored_piece_id
  LEFT JOIN tweets ON
    agent_authored_pieces.authored_piece_type = 'Tweet' AND
    tweets.id = agent_authored_pieces.authored_piece_id
